...
// Paths
const installFolder = './src/app/shared/services';
const srcPath = './service';
const srcFiles = {
...
const filters = {
  '__name__.service.ts': [{ 
    name: 'servicename', value: config }, {
    name: 'serviceclassname', value: config 
  }],
...
module.exports = function(name, options) {
  ...
  config.serviceclassname = `${name.replace(/(\b\w)/gi, (m) => m.toUpperCase())}Service`;
